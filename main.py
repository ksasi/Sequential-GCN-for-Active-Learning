...
if __name__ == '__main__':
    ...
    for trial in range(TRIALS):
        ...
        for cycle in range(CYCLES):
            ...
            sched_backbone = lr_scheduler.CosineAnnealingLR(optim_backbone, args.no_of_epochs, verbose = True)
            ...
            if method == 'lloss' or method == 'lloss_mse':
                ...
                sched_module   = lr_scheduler.CosineAnnealingLR(optim_module, args.no_of_epochs, verbose = True)
